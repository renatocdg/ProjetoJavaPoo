...
public class TelaObra extends JFrame {
	...
	private void cadastrarObra() {
		try {
			...
			switch (tipo) {
			case "Livro":
				nova = new Livro(codigo, titulo, autor, ano, "Disponível");
				break;
			case "Revista":
				nova = new Revista(codigo, titulo, autor, ano, "Disponível");
				break;
			case "Artigo":
				nova = new Artigo(codigo, titulo, autor, ano, "Disponível");
				break;
			}
			...
			JOptionPane.showMessageDialog(this, "Código e Ano devem ser números.");
		}
	}
